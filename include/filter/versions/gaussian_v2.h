...
#ifndef LTS_FILTERS_VERSIONS_GAUSSIAN_V2_H
#define LTS_FILTERS_VERSIONS_GAUSSIAN_V2_H
...
class GaussianKernel_v2 : public ImageKernel {
...
#endif // LTS_FILTERS_VERSIONS_GAUSSIAN_V2_H
